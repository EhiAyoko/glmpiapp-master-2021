...
export class AppComponent {
  ...
  doMenus() {
    console.log('ok')
    this.menus = [{ title: 'Home', slug: 'tabs/home', icon: 'home' },{ title: 'HERstories', slug: 'PostListPage', icon: 'book' },{ title: 'Daily Check In', slug: 'CheckinPage', icon: 'list' },{ title: 'Contact', slug: 'ContactPage', icon: 'mail' }]
